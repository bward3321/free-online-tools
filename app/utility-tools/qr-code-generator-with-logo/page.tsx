        ...
        <div className="max-w-[800px] mx-auto px-4 py-8 md:py-12">
          ...
          <article className="space-y-6 mb-10">
            <section className="rounded-xl border p-5" style={{ backgroundColor: "var(--surface)", borderColor: "var(--border)" }}>
              <h2 className="text-xl font-bold mb-3">How Logo Embedding Works</h2>
              <p className="leading-relaxed mb-3" style={{ fontSize: "16px", color: "var(--text-muted)" }}>QR codes have a remarkable feature: <strong style={{ color: "var(--text)" }}>error correction</strong>. At the highest level (Level H), a QR code can recover up to 30% of its data even when that portion is damaged, dirty, or &mdash; in this case &mdash; covered by a logo.</p>
              <p className="leading-relaxed" style={{ fontSize: "16px", color: "var(--text-muted)" }}>When you add a logo, the tool automatically switches to Level H error correction and places the logo in the center of the code with white padding. The center is the optimal position because QR code readers start scanning from the three corner finder patterns (the large squares), so the center is the last area needed.</p>
            </section>
            <section className="rounded-xl border p-5" style={{ backgroundColor: "var(--surface)", borderColor: "var(--border)" }}>
              <h2 className="text-xl font-bold mb-3">Logo Design Best Practices</h2>
          ...
          <div className="rounded-xl border p-4 mb-8 text-center" style={{ backgroundColor: "#2563EB1a", borderColor: "#2563EB40" }}>
            <p className="font-semibold" style={{ fontSize: "16px" }}>Create your branded QR code below &mdash; the logo section is already open for you.</p>
          </div>
        </div>
      </div>
