        ...
        <div className="max-w-[800px] mx-auto px-4 py-8 md:py-12">
          ...
          <article className="space-y-6 mb-10">
            <section className="rounded-xl border p-5" style={{ backgroundColor: "var(--surface)", borderColor: "var(--border)" }}>
              <h2 className="text-[22px] sm:text-[28px] font-bold mb-3">Navigating Complex API Responses</h2>
              <p className="leading-relaxed" style={{ fontSize: "17px", lineHeight: "1.7", color: "var(--text-muted)" }}>API responses can be hundreds or thousands of lines long. Scrolling through formatted text to find a specific nested value is tedious. The tree view lets you collapse everything, then expand only the branches you need. It&apos;s like a file explorer for your data.</p>
            </section>
            <section className="rounded-xl border p-5" style={{ backgroundColor: "var(--surface)", borderColor: "var(--border)" }}>
              <h2 className="text-[22px] sm:text-[28px] font-bold mb-3">Copy JSON Paths</h2>
              <p className="leading-relaxed" style={{ fontSize: "17px", lineHeight: "1.7", color: "var(--text-muted)" }}>Click any key in the tree to copy its full path to your clipboard. For example, clicking &ldquo;name&rdquo; under the first employee might copy <code>employees[0].name</code>. Paste this directly into your code to access that value.</p>
            </section>
          </article>
          <div className="rounded-xl border p-4 mb-8 text-center" style={{ backgroundColor: "#8BE9FD1a", borderColor: "#8BE9FD40" }}>
            <p className="font-semibold" style={{ fontSize: "17px" }}>Paste your JSON below &mdash; the tree view is already active.</p>
          </div>
        </div>
      </div>
