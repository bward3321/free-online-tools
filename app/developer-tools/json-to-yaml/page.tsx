        ...
        <div className="max-w-[800px] mx-auto px-4 py-8 md:py-12">
          ...
          <article className="space-y-6 mb-10">
            <section className="rounded-xl border p-5" style={{ backgroundColor: "var(--surface)", borderColor: "var(--border)" }}>
              <h2 className="text-[22px] sm:text-[28px] font-bold mb-3">JSON vs. YAML</h2>
              <p className="leading-relaxed" style={{ fontSize: "17px", lineHeight: "1.7", color: "var(--text-muted)" }}>Both formats represent the same data structures, but YAML uses <strong style={{ color: "var(--text)" }}>indentation instead of braces</strong> and is designed to be more human-readable. JSON is strict and unambiguous; YAML is flexible and concise. Many DevOps tools (Docker, Kubernetes, GitHub Actions) prefer YAML for configuration.</p>
            </section>
            <section className="rounded-xl border p-5" style={{ backgroundColor: "var(--surface)", borderColor: "var(--border)" }}>
          ...
          <div className="rounded-xl border p-4 mb-8 text-center" style={{ backgroundColor: "#8BE9FD1a", borderColor: "#8BE9FD40" }}>
            <p className="font-semibold" style={{ fontSize: "17px" }}>Paste your JSON below &mdash; the YAML converter is already active.</p>
          </div>
        </div>
      </div>
