        ...
        <div className="max-w-[800px] mx-auto px-4 py-8 md:py-12">
          ...
          <article className="space-y-6 mb-10">
            <section className="rounded-xl border p-5" style={{ backgroundColor: "var(--surface)", borderColor: "var(--border)" }}>
              <h2 className="text-[22px] sm:text-[28px] font-bold mb-3">Quick Base64 Decoding</h2>
              <p className="leading-relaxed" style={{ fontSize: "17px", lineHeight: "1.7", color: "var(--text-muted)" }}>Got a Base64 string from an API response, a JWT payload, or a log file? Paste it below and see the decoded text immediately. No buttons to click &mdash; the output updates in real time as you type or paste. The tool automatically strips whitespace and handles missing padding.</p>
            </section>
            <section className="rounded-xl border p-5" style={{ backgroundColor: "var(--surface)", borderColor: "var(--border)" }}>
              <h2 className="text-[22px] sm:text-[28px] font-bold mb-3">Code Examples</h2>
              <div className="space-y-3" style={{ fontSize: "17px", lineHeight: "1.7", color: "var(--text-muted)" }}>
