        ...
        <div className="max-w-[800px] mx-auto px-4 py-8 md:py-12">
          ...
          <article className="space-y-6 mb-10">
            <section className="rounded-xl border p-5" style={{ backgroundColor: "var(--surface)", borderColor: "var(--border)" }}>
              <h2 className="text-xl font-bold mb-3">Dummy Text for Design Workflows</h2>
              <p className="leading-relaxed" style={{ fontSize: "16px", color: "var(--text-muted)" }}>Dummy text is essential for evaluating typography, spacing, and content hierarchy in mockups. It shows how a design will look with real content before the content exists. This tool generates filler text in 10 distinct styles, letting you match the placeholder&apos;s tone to your project for more realistic prototypes.</p>
            </section>
            <section className="rounded-xl border p-5" style={{ backgroundColor: "var(--surface)", borderColor: "var(--border)" }}>
              <h2 className="text-xl font-bold mb-3">Tips for Realistic Mockups</h2>
              <p className="leading-relaxed" style={{ fontSize: "16px", color: "var(--text-muted)" }}>Use paragraph counts that match expected content length. Vary the amount per section &mdash; hero text needs 1-2 sentences, body sections need 2-3 paragraphs, and sidebars need short snippets. Enable headings to test content hierarchy. Matching the placeholder length to real-world content makes design reviews more productive.</p>
            </section>
          </article>
          <div className="rounded-xl border p-4 mb-8 text-center" style={{ backgroundColor: "#0596691a", borderColor: "#05966940" }}>
            <p className="font-semibold" style={{ fontSize: "16px" }}>Generate dummy text for your mockups below.</p>
          </div>
        </div>
      </div>
      ...
      <div style={{ backgroundColor: "var(--bg)", color: "var(--text)" }}>
        <div className="max-w-[800px] mx-auto px-4 pb-12">
          <section className="mb-8">
            <h2 className="text-2xl font-bold mb-4">What Is the Dummy Text Generator?</h2>
          ...
          <section className="mb-8">
            <h2 className="text-2xl font-bold mb-4">Best Practices for Using Dummy Text in Design</h2>
            <div className="space-y-4 rounded-xl border p-5" style={{ backgroundColor: "var(--surface)", borderColor: "var(--border)", fontSize: "16px", color: "var(--text-muted)" }}>
