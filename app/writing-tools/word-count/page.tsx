        ...
        <div className="max-w-[800px] mx-auto px-4 py-8 md:py-12">
          ...
          <article className="space-y-6 mb-10">
            <section className="rounded-xl border p-5" style={{ backgroundColor: "var(--surface)", borderColor: "var(--border)" }}>
              <h2 className="text-[22px] sm:text-[28px] font-bold mb-3">Common Word Count Requirements</h2>
              <p className="leading-relaxed mb-3" style={{ fontSize: "17px", lineHeight: "1.7", color: "var(--text-muted)" }}>Word counts are a standard requirement across writing contexts. <strong style={{ color: "var(--text)" }}>Academic essays</strong> typically range from 250 words (short response) to 8,000+ words (research papers). <strong style={{ color: "var(--text)" }}>Blog posts</strong> optimized for SEO typically target 1,500-2,500 words. <strong style={{ color: "var(--text)" }}>Business documents</strong> like cover letters should stay between 250-400 words.</p>
              <p className="leading-relaxed" style={{ fontSize: "17px", lineHeight: "1.7", color: "var(--text-muted)" }}>Knowing your word count helps you meet requirements, estimate reading and speaking times, and optimize content length for your audience and platform.</p>
            </section>
            <section className="rounded-xl border p-5" style={{ backgroundColor: "var(--surface)", borderColor: "var(--border)" }}>
              <h2 className="text-[22px] sm:text-[28px] font-bold mb-3">Reading Time &amp; Speaking Time</h2>
              <p className="leading-relaxed mb-3" style={{ fontSize: "17px", lineHeight: "1.7", color: "var(--text-muted)" }}>Average adults read at about <strong style={{ color: "var(--text)" }}>238 words per minute</strong> (research from the Journal of Memory and Language). A 1,000-word blog post takes about 4 minutes to read. A 5,000-word guide takes about 21 minutes.</p>
              <p className="leading-relaxed" style={{ fontSize: "17px", lineHeight: "1.7", color: "var(--text-muted)" }}>For presentations, the average speaking pace is <strong style={{ color: "var(--text)" }}>150 words per minute</strong>. A 10-minute talk needs about 1,500 words. This tool calculates both automatically from your word count.</p>
            </section>
          </article>
          <div className="rounded-xl border p-4 mb-8 text-center" style={{ backgroundColor: "#4F46E51a", borderColor: "#4F46E540" }}>
            <p className="font-semibold" style={{ fontSize: "17px" }}>Paste your text below to check the word count instantly.</p>
          </div>
        </div>
      </div>
