        ...
        <div className="max-w-[800px] mx-auto px-4 py-8 md:py-12">
          ...
          <article className="space-y-6 mb-10">
            <section className="rounded-xl border p-5" style={{ backgroundColor: "var(--surface)", borderColor: "var(--border)" }}>
              <h2 className="text-xl font-bold mb-3">Corporate-Ready Placeholder Text</h2>
              <p className="leading-relaxed" style={{ fontSize: "16px", color: "var(--text-muted)" }}>Standard Lorem Ipsum looks out of place in business presentations and corporate website mockups. Business Ipsum generates text that sounds like it belongs on a company website &mdash; filled with words like synergy, stakeholders, deliverables, and ROI. It gives mockups a professional feel while remaining clearly identifiable as placeholder content.</p>
            </section>
            <section className="rounded-xl border p-5" style={{ backgroundColor: "var(--surface)", borderColor: "var(--border)" }}>
              <h2 className="text-xl font-bold mb-3">Perfect for Business Documents</h2>
              <p className="leading-relaxed" style={{ fontSize: "16px", color: "var(--text-muted)" }}>Use Business Ipsum for corporate website layouts, PowerPoint templates, proposal documents, annual report designs, marketing material mockups, and investor deck prototypes. The business-appropriate vocabulary makes stakeholder reviews more productive.</p>
            </section>
          </article>
          <div className="rounded-xl border p-4 mb-8 text-center" style={{ backgroundColor: "#0596691a", borderColor: "#05966940" }}>
            <p className="font-semibold" style={{ fontSize: "16px" }}>Generate business placeholder text below.</p>
          </div>
        </div>
      </div>
      ...
      <div style={{ backgroundColor: "var(--bg)", color: "var(--text)" }}>
        <div className="max-w-[800px] mx-auto px-4 pb-12">
          <section className="mb-8">
            <h2 className="text-2xl font-bold mb-4">What Is the Business Ipsum Generator?</h2>
          ...
          <section className="mb-8">
            <h2 className="text-2xl font-bold mb-4">Why Professional Placeholder Text Matters for Business Mockups</h2>
            <div className="space-y-4 rounded-xl border p-5" style={{ backgroundColor: "var(--surface)", borderColor: "var(--border)", fontSize: "16px", color: "var(--text-muted)" }}>
