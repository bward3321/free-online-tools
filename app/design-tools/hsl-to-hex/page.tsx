        ...
        <div className="max-w-[800px] mx-auto px-4 py-8 md:py-12">
          ...
          <article className="space-y-6 mb-10">
            <section className="rounded-xl border p-5" style={{ backgroundColor: "var(--surface)", borderColor: "var(--border)" }}>
              <h2 className="text-[22px] sm:text-[28px] font-bold mb-3">Why HSL Is More Intuitive</h2>
              <p className="leading-relaxed" style={{ fontSize: "17px", lineHeight: "1.7", color: "var(--text-muted)" }}>HSL maps directly to how humans think about color. <strong style={{ color: "var(--text)" }}>Hue</strong> is the color itself &mdash; red at 0&deg;, yellow at 60&deg;, green at 120&deg;, cyan at 180&deg;, blue at 240&deg;, magenta at 300&deg;. <strong style={{ color: "var(--text)" }}>Saturation</strong> controls vividness (0% is gray, 100% is pure color). <strong style={{ color: "var(--text)" }}>Lightness</strong> controls brightness (0% is black, 50% is pure color, 100% is white).</p>
            </section>
            <section className="rounded-xl border p-5" style={{ backgroundColor: "var(--surface)", borderColor: "var(--border)" }}>
              <h2 className="text-[22px] sm:text-[28px] font-bold mb-3">HSL in CSS</h2>
              <p className="leading-relaxed" style={{ fontSize: "17px", lineHeight: "1.7", color: "var(--text-muted)" }}>Modern CSS fully supports HSL: <code style={{ color: "#059669" }}>color: hsl(217, 92%, 60%)</code> is equivalent to <code style={{ color: "#059669" }}>color: #3B82F6</code>. HSL is especially useful with CSS custom properties for creating theme variants: change just the lightness to get hover states, borders, and backgrounds from a single hue.</p>
            </section>
            <section className="rounded-xl border p-5" style={{ backgroundColor: "var(--surface)", borderColor: "var(--border)" }}>
              <h2 className="text-[22px] sm:text-[28px] font-bold mb-3">Creating Color Variations with HSL</h2>
              <p className="leading-relaxed" style={{ fontSize: "17px", lineHeight: "1.7", color: "var(--text-muted)" }}>Starting from <code style={{ color: "#059669" }}>hsl(217, 92%, 60%)</code> (blue), reduce lightness to 40% for a darker variant, increase to 80% for a lighter tint, or reduce saturation to 30% for a muted version. This is much harder with HEX or RGB, where all three values must change simultaneously to shift lightness.</p>
            </section>
          </article>
          <div className="rounded-xl border p-4 mb-8 text-center" style={{ backgroundColor: "#0596691a", borderColor: "#05966940" }}>
            <p className="font-semibold" style={{ fontSize: "17px" }}>Enter HSL values below to convert to HEX.</p>
          </div>
        </div>
      </div>
