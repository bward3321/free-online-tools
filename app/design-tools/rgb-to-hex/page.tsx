        ...
        <div className="max-w-[800px] mx-auto px-4 py-8 md:py-12">
          ...
          <article className="space-y-6 mb-10">
            <section className="rounded-xl border p-5" style={{ backgroundColor: "var(--surface)", borderColor: "var(--border)" }}>
              <h2 className="text-[22px] sm:text-[28px] font-bold mb-3">Why Convert RGB to HEX?</h2>
              <p className="leading-relaxed" style={{ fontSize: "17px", lineHeight: "1.7", color: "var(--text-muted)" }}>HEX codes are the most common way to specify colors in web design. They&apos;re compact (<code style={{ color: "#059669" }}>#3B82F6</code> vs <code style={{ color: "#059669" }}>rgb(59, 130, 246)</code>), universally recognized by designers and developers, and the standard format in brand guidelines, Figma, Sketch, and CSS.</p>
            </section>
            <section className="rounded-xl border p-5" style={{ backgroundColor: "var(--surface)", borderColor: "var(--border)" }}>
              <h2 className="text-[22px] sm:text-[28px] font-bold mb-3">The Conversion Process</h2>
              <p className="leading-relaxed" style={{ fontSize: "17px", lineHeight: "1.7", color: "var(--text-muted)" }}>Each RGB value (0-255) maps to a two-digit hexadecimal number (00-FF). R: 59 becomes <code style={{ color: "#059669" }}>3B</code>, G: 130 becomes <code style={{ color: "#059669" }}>82</code>, B: 246 becomes <code style={{ color: "#059669" }}>F6</code>. Combine them with a <code style={{ color: "#059669" }}>#</code> prefix: <code style={{ color: "#059669" }}>#3B82F6</code>. For RGBA, the alpha value (0-1) is multiplied by 255 and appended as two more hex digits.</p>
            </section>
            <section className="rounded-xl border p-5" style={{ backgroundColor: "var(--surface)", borderColor: "var(--border)" }}>
              <h2 className="text-[22px] sm:text-[28px] font-bold mb-3">Using HEX Codes in Web Design</h2>
              <p className="leading-relaxed" style={{ fontSize: "17px", lineHeight: "1.7", color: "var(--text-muted)" }}>In CSS: <code style={{ color: "#059669" }}>color: #3B82F6;</code> or <code style={{ color: "#059669" }}>background-color: #3B82F6;</code>. In HTML email templates, HEX is often the only reliable format. In design tokens and CSS custom properties: <code style={{ color: "#059669" }}>--primary: #3B82F6;</code>. Tailwind CSS maps its color classes to HEX values internally.</p>
            </section>
          </article>
          <div className="rounded-xl border p-4 mb-8 text-center" style={{ backgroundColor: "#0596691a", borderColor: "#05966940" }}>
            <p className="font-semibold" style={{ fontSize: "17px" }}>Enter RGB values below to get the HEX code.</p>
          </div>
        </div>
      </div>
