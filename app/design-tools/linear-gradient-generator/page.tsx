        ...
        <div className="max-w-[800px] mx-auto px-4 py-8 md:py-12">
          ...
          <article className="space-y-6 mb-10">
            <section className="rounded-xl border p-5" style={{ backgroundColor: "var(--surface)", borderColor: "var(--border)" }}>
              <h2 className="text-[22px] sm:text-[28px] font-bold mb-3">Understanding CSS Linear Gradients</h2>
              <p className="leading-relaxed" style={{ fontSize: "17px", lineHeight: "1.7", color: "var(--text-muted)" }}>The CSS <code style={{ color: "#059669" }}>linear-gradient()</code> function creates a color transition along a straight line. You specify a direction or angle, followed by two or more color stops. The browser smoothly interpolates between the colors. The simplest gradient &mdash; <code style={{ color: "#059669" }}>linear-gradient(#667eea, #764ba2)</code> &mdash; transitions from top to bottom by default.</p>
            </section>
            <section className="rounded-xl border p-5" style={{ backgroundColor: "var(--surface)", borderColor: "var(--border)" }}>
              <h2 className="text-[22px] sm:text-[28px] font-bold mb-3">Angle System Explained</h2>
              <p className="leading-relaxed" style={{ fontSize: "17px", lineHeight: "1.7", color: "var(--text-muted)" }}>Gradient angles start at 0&deg; (bottom to top) and rotate clockwise: 90&deg; goes left to right, 180&deg; top to bottom, 270&deg; right to left. You can also use direction keywords like <code style={{ color: "#059669" }}>to right</code>, <code style={{ color: "#059669" }}>to bottom left</code>, or <code style={{ color: "#059669" }}>to top right</code>. Diagonal gradients (45&deg;, 135&deg;) are popular for UI backgrounds because they add visual energy without being too aggressive.</p>
            </section>
            <section className="rounded-xl border p-5" style={{ backgroundColor: "var(--surface)", borderColor: "var(--border)" }}>
              <h2 className="text-[22px] sm:text-[28px] font-bold mb-3">Working with Multiple Color Stops</h2>
              <p className="leading-relaxed" style={{ fontSize: "17px", lineHeight: "1.7", color: "var(--text-muted)" }}>Add more than two color stops to create rich, layered gradients. Each stop can have a percentage position: <code style={{ color: "#059669" }}>linear-gradient(90deg, #ff0000 0%, #ffff00 50%, #00ff00 100%)</code>. Place two stops at the same position to create a hard edge. Stops without explicit positions are evenly distributed between their neighbors.</p>
            </section>
          </article>
          <div className="rounded-xl border p-4 mb-8 text-center" style={{ backgroundColor: "#0596691a", borderColor: "#05966940" }}>
            <p className="font-semibold" style={{ fontSize: "17px" }}>Create your linear gradient below.</p>
          </div>
        </div>
      </div>
      ...
      <div style={{ backgroundColor: "var(--bg)", color: "var(--text)" }}>
        <div className="max-w-[800px] mx-auto px-4 pb-12">
          ...
          <section className="mb-8">
            <h2 className="text-[22px] sm:text-[28px] font-bold mb-4">What Is the Linear Gradient Generator?</h2>
          ...
          <section className="mb-8">
            <h2 className="text-[22px] sm:text-[28px] font-bold mb-4">Understanding Gradient Angles and Directions</h2>
            <div className="space-y-4 rounded-xl border p-5" style={{ backgroundColor: "var(--surface)", borderColor: "var(--border)", fontSize: "17px", lineHeight: "1.7", color: "var(--text-muted)" }}>
