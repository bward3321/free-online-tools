        ...
        <div className="max-w-[800px] mx-auto px-4 py-8 md:py-12">
          ...
          <article className="space-y-6 mb-10">
            <section className="rounded-xl border p-5" style={{ backgroundColor: "var(--surface)", borderColor: "var(--border)" }}>
              <h2 className="text-[22px] sm:text-[28px] font-bold mb-3">The Background-Size Animation Technique</h2>
              <p className="leading-relaxed" style={{ fontSize: "17px", lineHeight: "1.7", color: "var(--text-muted)" }}>CSS gradient animations use a clever technique: create a gradient larger than the element using <code style={{ color: "#059669" }}>background-size: 200% 200%</code>, then animate the <code style={{ color: "#059669" }}>background-position</code> with <code style={{ color: "#059669" }}>@keyframes</code>. The oversized gradient scrolls behind the element, creating a smooth flowing effect at 60fps.</p>
            </section>
            <section className="rounded-xl border p-5" style={{ backgroundColor: "var(--surface)", borderColor: "var(--border)" }}>
              <h2 className="text-[22px] sm:text-[28px] font-bold mb-3">Three Animation Modes</h2>
              <p className="leading-relaxed" style={{ fontSize: "17px", lineHeight: "1.7", color: "var(--text-muted)" }}>The <strong>Shift</strong> animation slides the gradient across the element &mdash; best for hero sections and backgrounds. <strong>Hue Rotate</strong> cycles the gradient through all colors using <code style={{ color: "#059669" }}>filter: hue-rotate()</code> &mdash; ideal for loading states. <strong>Pulse</strong> fades the gradient opacity &mdash; subtle enough for buttons and cards.</p>
            </section>
            <section className="rounded-xl border p-5" style={{ backgroundColor: "var(--surface)", borderColor: "var(--border)" }}>
              <h2 className="text-[22px] sm:text-[28px] font-bold mb-3">Performance Considerations</h2>
              <p className="leading-relaxed" style={{ fontSize: "17px", lineHeight: "1.7", color: "var(--text-muted)" }}>Modern browsers GPU-accelerate CSS animations, so performance is generally excellent. Use <code style={{ color: "#059669" }}>will-change: background-position</code> as a hint. Longer durations (6-10s) feel more elegant. Consider the <code style={{ color: "#059669" }}>prefers-reduced-motion</code> media query to respect user preferences.</p>
            </section>
          </article>
          <div className="rounded-xl border p-4 mb-8 text-center" style={{ backgroundColor: "#0596691a", borderColor: "#05966940" }}>
            <p className="font-semibold" style={{ fontSize: "17px" }}>Create your animated gradient below.</p>
          </div>
        </div>
      </div>
      ...
      <div style={{ backgroundColor: "var(--bg)", color: "var(--text)" }}>
        <div className="max-w-[800px] mx-auto px-4 pb-12">
          ...
          <section className="mb-8">
            <h2 className="text-[22px] sm:text-[28px] font-bold mb-4">What Is the Animated Gradient Generator?</h2>
          ...
          <section className="mb-8">
            <h2 className="text-[22px] sm:text-[28px] font-bold mb-4">How CSS Gradient Animations Work</h2>
            <div className="space-y-4 rounded-xl border p-5" style={{ backgroundColor: "var(--surface)", borderColor: "var(--border)", fontSize: "17px", lineHeight: "1.7", color: "var(--text-muted)" }}>
