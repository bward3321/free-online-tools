      ...
      <div className="min-h-screen" style={{ backgroundColor: "var(--bg)", color: "var(--text)" }}>
        <div className="max-w-[800px] mx-auto px-4 py-8 md:py-12">
          ...
          <article className="space-y-6 mb-10">
            ...
            <section className="rounded-xl border p-5" style={{ backgroundColor: "var(--surface)", borderColor: "var(--border)" }}>
              <h2 className="text-xl font-bold mb-3">Harmony Types Explained</h2>
              <p className="leading-relaxed" style={{ fontSize: "16px", color: "var(--text-muted)" }}><strong style={{ color: "var(--text)" }}>Complementary</strong> (180&deg;): high contrast, energetic. <strong style={{ color: "var(--text)" }}>Analogous</strong> (&plusmn;30&deg;): calm, cohesive. <strong style={{ color: "var(--text)" }}>Triadic</strong> (120&deg;): vibrant, balanced. <strong style={{ color: "var(--text)" }}>Split-complementary</strong>: contrast with less tension. <strong style={{ color: "var(--text)" }}>Tetradic</strong>: rich, complex schemes. <strong style={{ color: "var(--text)" }}>Square</strong> (90&deg;): balanced four-color schemes. <strong style={{ color: "var(--text)" }}>Monochromatic</strong>: elegant single-hue variations.</p>
            </section>
          </article>
          <div className="rounded-xl border p-4 mb-8 text-center" style={{ backgroundColor: "#0596691a", borderColor: "#05966940" }}>
            <p className="font-semibold" style={{ fontSize: "16px" }}>Pick a color below to generate palettes.</p>
          </div>
        </div>
      </div>
