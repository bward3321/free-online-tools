        ...
        <div className="max-w-[800px] mx-auto px-4 py-8 md:py-12">
          ...
          <article className="space-y-6 mb-10">
            <section className="rounded-xl border p-5" style={{ backgroundColor: "var(--surface)", borderColor: "var(--border)" }}>
              <h2 className="text-[22px] sm:text-[28px] font-bold mb-3">Finding the Right Gradient</h2>
              <p className="leading-relaxed" style={{ fontSize: "17px", lineHeight: "1.7", color: "var(--text-muted)" }}>Choosing the right gradient can make or break a design. Use the category filter pills to browse by mood &mdash; Warm gradients work for energetic landing pages and CTAs, Cool tones suit corporate and tech interfaces, Pastel shades are perfect for gentle, approachable designs, and Dark gradients create dramatic hero sections. Search by color name to find gradients that match your brand palette.</p>
            </section>
            <section className="rounded-xl border p-5" style={{ backgroundColor: "var(--surface)", borderColor: "var(--border)" }}>
              <h2 className="text-[22px] sm:text-[28px] font-bold mb-3">Color Theory for Gradients</h2>
              <p className="leading-relaxed" style={{ fontSize: "17px", lineHeight: "1.7", color: "var(--text-muted)" }}>The best gradients follow color theory principles. Analogous colors (adjacent on the color wheel, like blue to purple) create smooth, harmonious transitions. Complementary colors (opposite, like orange to blue) create high contrast. Keep saturation and lightness consistent across stops for a professional look. When in doubt, start with a preset and adjust from there.</p>
            </section>
            <section className="rounded-xl border p-5" style={{ backgroundColor: "var(--surface)", borderColor: "var(--border)" }}>
              <h2 className="text-[22px] sm:text-[28px] font-bold mb-3">Gradients in Modern Web Design</h2>
              <p className="leading-relaxed" style={{ fontSize: "17px", lineHeight: "1.7", color: "var(--text-muted)" }}>Gradients work as hero section backgrounds, button fills, text effects, card overlays, and section dividers. For hero sections, use subtle 2-color gradients at wide angles. For buttons, keep gradients subtle to maintain readability. Always check contrast when placing text over gradient backgrounds.</p>
            </section>
          </article>
          <div className="rounded-xl border p-4 mb-8 text-center" style={{ backgroundColor: "#0596691a", borderColor: "#05966940" }}>
            <p className="font-semibold" style={{ fontSize: "17px" }}>Browse the gradient gallery below and click any gradient to customize it.</p>
          </div>
        </div>
      </div>
      ...
      <div style={{ backgroundColor: "var(--bg)", color: "var(--text)" }}>
        <div className="max-w-[800px] mx-auto px-4 pb-12">
          ...
          <section className="mb-8">
            <h2 className="text-[22px] sm:text-[28px] font-bold mb-4">What Is the Gradient Color Palette?</h2>
          ...
          <section className="mb-8">
            <h2 className="text-[22px] sm:text-[28px] font-bold mb-4">How to Choose Gradient Colors That Work Together</h2>
            <div className="space-y-4 rounded-xl border p-5" style={{ backgroundColor: "var(--surface)", borderColor: "var(--border)", fontSize: "17px", lineHeight: "1.7", color: "var(--text-muted)" }}>
