        ...
        <div className="max-w-[800px] mx-auto px-4 py-8 md:py-12">
          ...
          <article className="space-y-6 mb-10">
            <section className="rounded-xl border p-5" style={{ backgroundColor: "var(--surface)", borderColor: "var(--border)" }}>
              <h2 className="text-[22px] sm:text-[28px] font-bold mb-3">The Structure of a HEX Code</h2>
              <p className="leading-relaxed" style={{ fontSize: "17px", lineHeight: "1.7", color: "var(--text-muted)" }}>A hex color code is a <code style={{ color: "#059669" }}>#</code> followed by six hexadecimal digits (0-9, A-F). The six digits form three pairs: <strong style={{ color: "var(--text)" }}>RR</strong> (red), <strong style={{ color: "var(--text)" }}>GG</strong> (green), <strong style={{ color: "var(--text)" }}>BB</strong> (blue). Each pair represents a value from 0 to 255 in base-16. For example, <code style={{ color: "#059669" }}>#3B82F6</code> means red=59, green=130, blue=246.</p>
            </section>
            <section className="rounded-xl border p-5" style={{ backgroundColor: "var(--surface)", borderColor: "var(--border)" }}>
              <h2 className="text-[22px] sm:text-[28px] font-bold mb-3">Essential HEX Codes to Know</h2>
              <p className="leading-relaxed" style={{ fontSize: "17px", lineHeight: "1.7", color: "var(--text-muted)" }}><code style={{ color: "#059669" }}>#000000</code> Black. <code style={{ color: "#059669" }}>#FFFFFF</code> White. <code style={{ color: "#059669" }}>#FF0000</code> Pure red. <code style={{ color: "#059669" }}>#00FF00</code> Pure green. <code style={{ color: "#059669" }}>#0000FF</code> Pure blue. <code style={{ color: "#059669" }}>#808080</code> Medium gray. <code style={{ color: "#059669" }}>#FFA500</code> Orange. <code style={{ color: "#059669" }}>#800080</code> Purple. <code style={{ color: "#059669" }}>#333333</code> Dark gray (common text color). <code style={{ color: "#059669" }}>#F5F5F5</code> Light gray (common background).</p>
            </section>
            <section className="rounded-xl border p-5" style={{ backgroundColor: "var(--surface)", borderColor: "var(--border)" }}>
              <h2 className="text-[22px] sm:text-[28px] font-bold mb-3">HEX Across Design Tools</h2>
              <p className="leading-relaxed" style={{ fontSize: "17px", lineHeight: "1.7", color: "var(--text-muted)" }}>HEX codes are universal across design tools. <strong style={{ color: "var(--text)" }}>CSS/HTML:</strong> <code style={{ color: "#059669" }}>color: #3B82F6</code>. <strong style={{ color: "var(--text)" }}>Figma:</strong> paste hex directly into the color input. <strong style={{ color: "var(--text)" }}>Photoshop:</strong> enter in the color picker&apos;s hex field. <strong style={{ color: "var(--text)" }}>Email templates:</strong> HEX is the most reliable color format for HTML email.</p>
            </section>
          </article>
          <div className="rounded-xl border p-4 mb-8 text-center" style={{ backgroundColor: "#0596691a", borderColor: "#05966940" }}>
            <p className="font-semibold" style={{ fontSize: "17px" }}>Explore and convert any HEX color below.</p>
          </div>
        </div>
      </div>
