      ...
      <div className="min-h-screen" style={{ backgroundColor: "var(--bg)", color: "var(--text)" }}>
        <div className="max-w-[800px] mx-auto px-4 py-8 md:py-12">
          ...
          <article className="space-y-6 mb-10">
            ...
            <section className="rounded-xl border p-5" style={{ backgroundColor: "var(--surface)", borderColor: "var(--border)" }}>
              <h2 className="text-xl font-bold mb-3">Shape and Size Options</h2>
              <p className="leading-relaxed" style={{ fontSize: "16px", color: "var(--text-muted)" }}>Radial gradients support two shapes: <code style={{ color: "#059669" }}>circle</code> maintains equal radii regardless of container aspect ratio, while <code style={{ color: "#059669" }}>ellipse</code> (the default) stretches to fill the container. Four size keywords control the gradient&apos;s extent: <code style={{ color: "#059669" }}>closest-side</code>, <code style={{ color: "#059669" }}>farthest-side</code>, <code style={{ color: "#059669" }}>closest-corner</code>, and <code style={{ color: "#059669" }}>farthest-corner</code>.</p>
            </section>
            <section className="rounded-xl border p-5" style={{ backgroundColor: "var(--surface)", borderColor: "var(--border)" }}>
              <h2 className="text-xl font-bold mb-3">Positioning the Center Point</h2>
      ...
      <div style={{ backgroundColor: "var(--bg)", color: "var(--text)" }}>
        <div className="max-w-[800px] mx-auto px-4 pb-12">
          ...
          <section className="mb-8">
            <h2 className="text-2xl font-bold mb-4">What Is the Radial Gradient Generator?</h2>
          ...
          <section className="mb-8">
            <h2 className="text-2xl font-bold mb-4">Circle vs Ellipse &mdash; When to Use Each</h2>
            <div className="space-y-4 rounded-xl border p-5" style={{ backgroundColor: "var(--surface)", borderColor: "var(--border)", fontSize: "16px", color: "var(--text-muted)" }}>
